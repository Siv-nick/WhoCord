...
class EmailInvestigationStage(Stage):
    ...
    def run(self, ctx: InvestigationContext, emit: EmitFn = lambda *_: None) -> None:
        ...
        try:
            ...
            if mosint_data:
                if isinstance(mosint_data, list):
                    ...
                    accounts = mosint_data.get("data", []) or mosint_data.get("results", [])
                else:
                    accounts = []
        ...
        # Feed discovered URLs into all_urls
        ...
        try:
            ...
            for r in results:
                ...
                if url and url.startswith("http"):
                    ...
                    # Bug 1 fix: pass emit through
                    self._fetch_and_store_api_data(ctx, url, emit)
                    found += 1
    ...
    def _fetch_and_store_api_data(
        ...
        try:
            ...
            if (r.status_code == 200 and
                ...
                ctx.intel_core.add_intel(
                    "social_profiles", key, json.dumps(data), source="blackbird_api",
                )
